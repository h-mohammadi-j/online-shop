  ...
  try {
    ...
    data.forEach((card) => {
      products.innerHTML += `
                    ...
                    <div class="min-h-[500px] min-h-[650px] bg-white rounded-lg shadow-[0_0_10px_rgba(0,0,0,0.5)] overflow-hidden text-center flex flex-col items-center hover:scale-105 transition-all duration-300">
                    ...
                    <div class="py-1.5 px-4 flex flex-col items-center gap-1.5">
                        ...
                        <p class="p-2.5 font-bold text-gray-500 tracking-wider h-[180px] overflow-y-auto text-left">${card.description}</p>
