            ...
            <div class="relative w-full  sm:w-[800px] p-[40px] bg-[rgba(255,255,255,0.15)] backdrop-blur-md rounded-[20px] shadow-[0_15px_35px_rgba(0,0,0,0.2)] border-[rgba(255,255,255,0.1)] border z-[10] animation-fadeIn  ">
                ...
                <form id="loginForm">
                    ...
                    <div class="w-full flex flex-col md:flex-row justify-center gap-4">
                        ...
                        <div class="w-full relative mb-[30px]">
                            <input class="w-full px-4 py-4 bg-[rgba(255,255,255,0.1)] border-none outline-none rounded-full text-white tracking-[1px] shadow-[0_5px_15px_rgba(0,0,0,0.05) transition-all duration-300 placeholder:text-[rgba(255,255,255,0.7)] focus:bg-[rgba(255,255,255,0.2)] transform focus:translate-y-[-5px] " type="password" placeholder="Last Name" required>
                            <i class="absolute right-[20px] top-[50%] transform translate-y-[-50%] text-white fas fa-user"></i>
                        </div>
                    </div>

                    <div class="relative mb-[30px]">
                        <input class="w-full px-4 py-4 bg-[rgba(255,255,255,0.1)] border-none outline-none rounded-full text-white tracking-[1px] shadow-[0_5px_15px_rgba(0,0,0,0.05) transition-all duration-300 placeholder:text-[rgba(255,255,255,0.7)] focus:bg-[rgba(255,255,255,0.2)] transform focus:translate-y-[-5px] " type="text" placeholder="Phone Number" required>
                        <i class="absolute right-[20px] top-[50%] transform translate-y-[-50%] text-white fas fa-phone"></i>
                    </div>
                    <div class="relative mb-[30px]">
                    ...
                    <div class="relative mb-[30px]">
                        <input class="w-full px-4 py-4 bg-[rgba(255,255,255,0.1)] border-none outline-none rounded-full text-white tracking-[1px] shadow-[0_5px_15px_rgba(0,0,0,0.05) transition-all duration-300 placeholder:text-[rgba(255,255,255,0.7)] focus:bg-[rgba(255,255,255,0.2)] transform focus:translate-y-[-5px] " type="password" placeholder="Confirm Password" required>
                        <i class="absolute right-[20px] top-[50%] transform translate-y-[-50%] text-white fas fa-lock"></i>
                    </div>
                    ...
                    <div class="mt-[20px] text-center text-white ">
                        <p class="text-sm text-[rgba(255,255,255,0.8)]">Do you have an account? <a class="text-white text-lg decoration-0 transition-all duration-300 hover:underline hover:decoration-white hover:decoration-solid " href="../loginForm/loginForm.html">Sign In</a></p>
