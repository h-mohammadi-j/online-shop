 const menu = () => {
    ...
    return ( 
        `<header class="w-full h-[60px] bg-gray-800 px-10 flex  items-center justify-between text-white relative z-1 md:z-0">
            ...
            <ul id="nav" class="flex flex-col w-full -z-30 md:bg-transparent text-center perspective-[1000px] transform translate-y-[-100%] md:flex-row md:top-0 md:translate-x-0 md:left-0 transition-all duration-300 justify-center absolute bottom-30px left-0 md:flex md:gap-4 md:translate-y-0 ">
                ...
                <li class="bg-gray-800 py-4 md;py-0  md:w-fit md:static md:visible md:block origin-center border-cyan-400 border-t-[1px] md:border-0  absolute w-0  opacity-0 md:opacity-100 left-0 transform transition-all duration-300 invisible cursor-pointer">Home</li>
                <li class="bg-gray-800 py-4 md;py-0 md:opacity-100 md:w-fit md:static md:visible md:block origin-center border-cyan-400 border-t-[1px] md:border-0  absolute w-0  opacity-0  left-0 transform transition-all duration-300 invisible cursor-pointer">Product</li>
                <li class="bg-gray-800 py-4 md;py-0 md:opacity-100 md:w-fit md:static md:visible md:block origin-center border-cyan-400 border-t-[1px] md:border-0  absolute w-0  opacity-0  left-0 transform transition-all duration-300 invisible cursor-pointer">About</li>
